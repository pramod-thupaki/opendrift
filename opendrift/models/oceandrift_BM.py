...
class OceanDrift(OpenDriftSimulation):
    ...
    def update_terminal_velocity(self, Tprofiles=None, Sprofiles=None,
        ...
        """
        # """Calculate terminal velocity for Pelagic Egg (retrieved from ChemicalDrift.py)
    ...
    def vertical_mixing(self, store_depths=False):
        ...
        for i in range(0, ntimes_mix):
            ...
            #"update_terminal_velocity" currently deactivated - these two lines
            # will simply draw the default terminal_velocity each time
            #ChemicalDrift uses the Sundby1983 algorithm to update this, which could
            # be implemented by defining env variables (profile density, particle size)
